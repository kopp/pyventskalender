...
try:
    from pyventskalender.tag14_loesung import VERLOREN_BEI_SO_VIELEN_FEHLERN, zu_ratendes_wort, galgenmannbild
except ImportError:
    from tag14_loesung import VERLOREN_BEI_SO_VIELEN_FEHLERN, zu_ratendes_wort, galgenmannbild
