# Wenn man eine Programmiersprache lernt, ist die erste Aufgabe immer, den Text
# "Hallo Welt" zu erzeugen.
# Das zeigt vor allem, dass man die wichtigsten Sachen richtig installiert hat
# usw. und dann direkt loslegen kann.
# In Python ist das Programm eigentlich sehr einfach.
#
...
# "Zellen" auszuführen.
# Eine Zelle ist alles, was zwischen zwei Zeilen steht, die mit `# %%` oder
# `#%%` beginnen.
# In Visual Studio Code kann man dann mit der Maus auf "Run Cell" klicken und
